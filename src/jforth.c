...
#define ADD_WORD(label, buf, flags)\
cell_t *CWP_##label;                        \
{                                         \
...
main(int argc, char *argv[])
{
	...
	ADD_WORD(ADD, "+", F_NOTSET)
	ADD_WORD(BASE, "BASE", F_NOTSET)
	ADD_WORD(BRANCH, "BRANCH", F_NOTSET)
	ADD_WORD(BRANCHCOND, "0BRANCH", F_NOTSET)
	ADD_WORD(CHAR, "CHAR", F_NOTSET)
	ADD_WORD(CREATE, "CREATE", F_NOTSET)
	ADD_WORD(COMMA, ",", F_NOTSET)
	ADD_WORD(DIVMOD, "/MOD", F_NOTSET)
	ADD_WORD(DOCOL, "DOCOL", F_NOTSET)
	ADD_WORD(DROP, "DROP", F_NOTSET)
	ADD_WORD(TWODROP, "2DROP", F_NOTSET)
	ADD_WORD(DUP, "DUP", F_NOTSET)
	ADD_WORD(EMIT, "EMIT", F_NOTSET)
	ADD_WORD(EXIT, "EXIT", F_NOTSET)
	ADD_WORD(FETCH, "@", F_NOTSET)
	ADD_WORD(FIND, "FIND", F_NOTSET)
	ADD_WORD(HERE, "HERE", F_NOTSET)
	ADD_WORD(HIDE, "HIDE", F_NOTSET)
	ADD_WORD(HIDDEN, "HIDDEN", F_NOTSET)
	ADD_WORD(IMMEDIATE, "IMMEDIATE", F_IMMED)
	ADD_WORD(INTERPRET, "INTERPRET", F_NOTSET)
	ADD_WORD(LATEST, "LATEST", F_NOTSET)
	ADD_WORD(LBRAC, "[", F_IMMED)
	ADD_WORD(LIT, "LIT", F_NOTSET)
	ADD_WORD(MUL, "*", F_NOTSET)
	ADD_WORD(OVER, "OVER", F_NOTSET)
	ADD_WORD(RBRAC, "]", F_NOTSET)
	ADD_WORD(STORE, "!", F_NOTSET)
	ADD_WORD(SUB, "-", F_NOTSET)
	ADD_WORD(SWAP, "SWAP", F_NOTSET)
	ADD_WORD(TWOSWAP, "2SWAP", F_NOTSET)
	ADD_WORD(TOCFA, ">CFA", F_NOTSET)
	ADD_WORD(WORD, "WORD", F_NOTSET)
	ADD_WORD(ZEQU, "0=", F_NOTSET)
	ADD_WORD(GT, ">", F_NOTSET)
	ADD_WORD(GTEQ, ">=", F_NOTSET)
	ADD_WORD(LT, "<", F_NOTSET)
	ADD_WORD(LTEQ, "<=", F_NOTSET)
	ADD_WORD(EQ, "=", F_NOTSET)
	ADD_WORD(NEQ, "<>", F_NOTSET)
	ADD_WORD(KEY, "KEY", F_NOTSET)
	ADD_WORD(DSPBOT, "DSP@", F_NOTSET)
	ADD_WORD(DSPTOP, "DSP0", F_NOTSET)
	ADD_WORD(ROT, "ROT", F_NOTSET)
	ADD_WORD(NROT, "-ROT", F_NOTSET)
	ADD_WORD(AND, "AND", F_NOTSET)
	ADD_WORD(OR, "OR", F_NOTSET)
	ADD_WORD(XOR, "XOR", F_NOTSET)
	ADD_WORD(INVERT, "INVERT", F_NOTSET)
	ADD_WORD(STATE, "STATE", F_NOTSET)
	ADD_WORD(CSTORE, "C!", F_NOTSET)
	ADD_WORD(CFETCH, "C@", F_NOTSET)
	ADD_WORD(TWODUP, "2DUP", F_NOTSET)
	ADD_WORD(LITSTRING, "LITSTRING", F_NOTSET)
	ADD_WORD(TELL, "TELL", F_NOTSET)
	ADD_WORD(FIMMED, "F_IMMED", F_NOTSET)
	ADD_WORD(FHIDDEN, "F_HIDDEN", F_NOTSET)
	ADD_WORD(TOR, ">R", F_NOTSET)
	ADD_WORD(FROMR, "R>", F_NOTSET)
	ADD_WORD(DOT, ".", F_NOTSET)
	ADD_WORD(ONEPLUS, "1+", F_NOTSET)
	ADD_WORD(ONEMINUS, "1-", F_NOTSET)
	ADD_WORD(CMOVE, "CMOVE", F_NOTSET)
